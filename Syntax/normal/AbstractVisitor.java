...
public class AbstractVisitor<R,A> implements AllVisitor<R,A> {
    ...
    /* Type */
    public R visit(Syntax.normal.Absyn.BoolType p, A arg) { return visitDefault(p, arg); }
    public R visit(Syntax.normal.Absyn.IntType p, A arg) { return visitDefault(p, arg); }
    public R visit(Syntax.normal.Absyn.FunType p, A arg) { return visitDefault(p, arg); }
    public R visitDefault(Syntax.normal.Absyn.Type p, A arg) {
      throw new IllegalArgumentException(this.getClass().getName() + ": " + p);
    }
