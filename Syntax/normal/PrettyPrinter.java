...
public class PrettyPrinter
{
  ...
  public static String print(Syntax.normal.Absyn.Type foo)
  {
    pp(foo, 0);
    trim();
    String temp = buf_.toString();
  ...
  public static String show(Syntax.normal.Absyn.Type foo)
  {
    sh(foo);
    String temp = buf_.toString();
    buf_.delete(0,buf_.length());
  ...
  private static void ppListExpr(java.util.Iterator<Syntax.normal.Absyn.Expr> it, int _i_)
  {
    if (it.hasNext())
    {
      Syntax.normal.Absyn.Expr el = it.next();
      if (!it.hasNext())
      { /* last */
        pp(el, _i_);
      }
  ...
  private static void pp(Syntax.normal.Absyn.Expr foo, int _i_)
  {
    ...
    else     if (foo instanceof Syntax.normal.Absyn.Abstraction)
    {
       ...
       pp(_abstraction.ident_1, 0);
       render("(");
       pp(_abstraction.type_2, 0);
       pp(_abstraction.ident_2, 0);
       render(")");
       render("{");
       render("return");
    ...
    else     if (foo instanceof Syntax.normal.Absyn.ConstTrue)
    {
  ...
  private static void pp(Syntax.normal.Absyn.Type foo, int _i_)
  {
    if (foo instanceof Syntax.normal.Absyn.BoolType)
    {
       Syntax.normal.Absyn.BoolType _booltype = (Syntax.normal.Absyn.BoolType) foo;
       if (_i_ > 0) render(_L_PAREN);
       render("Bool");
       if (_i_ > 0) render(_R_PAREN);
    }
    else     if (foo instanceof Syntax.normal.Absyn.IntType)
    {
       Syntax.normal.Absyn.IntType _inttype = (Syntax.normal.Absyn.IntType) foo;
       if (_i_ > 0) render(_L_PAREN);
       render("Int");
       if (_i_ > 0) render(_R_PAREN);
    }
    else     if (foo instanceof Syntax.normal.Absyn.FunType)
    {
       Syntax.normal.Absyn.FunType _funtype = (Syntax.normal.Absyn.FunType) foo;
       if (_i_ > 0) render(_L_PAREN);
  ...
  private static void sh(Syntax.normal.Absyn.Expr foo)
  {
    ...
    if (foo instanceof Syntax.normal.Absyn.Abstraction)
    {
       ...
       sh(_abstraction.ident_1);
       sh(_abstraction.type_2);
       sh(_abstraction.ident_2);
  ...
  private static void sh(Syntax.normal.Absyn.Type foo)
  {
    if (foo instanceof Syntax.normal.Absyn.BoolType)
    {
       Syntax.normal.Absyn.BoolType _booltype = (Syntax.normal.Absyn.BoolType) foo;
    ...
    if (foo instanceof Syntax.normal.Absyn.IntType)
    {
       Syntax.normal.Absyn.IntType _inttype = (Syntax.normal.Absyn.IntType) foo;
       render("IntType");
    }
    if (foo instanceof Syntax.normal.Absyn.FunType)
    {
       Syntax.normal.Absyn.FunType _funtype = (Syntax.normal.Absyn.FunType) foo;
       render("(");
       render("FunType");
