...
public class PrettyPrinter
{
  ...
  public static String print(Syntax.nameless.Absyn.Program foo)
  {
    pp(foo, 0);
    trim();
  ...
  public static String show(Syntax.nameless.Absyn.Program foo)
  {
    sh(foo);
    String temp = buf_.toString();
    buf_.delete(0,buf_.length());
  ...
  public static String print(Syntax.nameless.Absyn.ListExpr foo)
  {
    pp(foo, 0);
    trim();
    String temp = buf_.toString();
  ...
  public static String show(Syntax.nameless.Absyn.ListExpr foo)
  {
    sh(foo);
    String temp = buf_.toString();
    buf_.delete(0,buf_.length());
  ...
  public static String print(Syntax.nameless.Absyn.Type foo)
  {
    pp(foo, 0);
    trim();
    String temp = buf_.toString();
  ...
  public static String show(Syntax.nameless.Absyn.Type foo)
  {
    sh(foo);
    String temp = buf_.toString();
    buf_.delete(0,buf_.length());
  ...
  private static void pp(Syntax.nameless.Absyn.Program foo, int _i_)
  {
    if (foo instanceof Syntax.nameless.Absyn.ProgramExprs)
    {
       Syntax.nameless.Absyn.ProgramExprs _programexprs = (Syntax.nameless.Absyn.ProgramExprs) foo;
  ...
  private static void pp(Syntax.nameless.Absyn.ListExpr foo, int _i_)
  {
    ppListExpr(foo.iterator(), _i_);
  }

  private static void ppListExpr(java.util.Iterator<Syntax.nameless.Absyn.Expr> it, int _i_)
  {
    if (it.hasNext())
    {
      Syntax.nameless.Absyn.Expr el = it.next();
      if (!it.hasNext())
      { /* last */
        pp(el, _i_);
      }
  ...
  private static void pp(Syntax.nameless.Absyn.Expr foo, int _i_)
  {
    ...
    else     if (foo instanceof Syntax.nameless.Absyn.Abstraction)
    {
       ...
       if (_i_ > 0) render(_L_PAREN);
       render("fun");
       pp(_abstraction.type_1, 0);
       pp(_abstraction.ident_, 0);
       render("(");
       pp(_abstraction.type_2, 0);
       render(")");
       render("{");
       render("return");
  ...
  private static void pp(Syntax.nameless.Absyn.Type foo, int _i_)
  {
    if (foo instanceof Syntax.nameless.Absyn.BoolType)
    {
       Syntax.nameless.Absyn.BoolType _booltype = (Syntax.nameless.Absyn.BoolType) foo;
       if (_i_ > 0) render(_L_PAREN);
       render("Bool");
       if (_i_ > 0) render(_R_PAREN);
    }
    else     if (foo instanceof Syntax.nameless.Absyn.IntType)
    {
       Syntax.nameless.Absyn.IntType _inttype = (Syntax.nameless.Absyn.IntType) foo;
       if (_i_ > 0) render(_L_PAREN);
       render("Int");
       if (_i_ > 0) render(_R_PAREN);
    }
    else     if (foo instanceof Syntax.nameless.Absyn.FunType)
    {
       Syntax.nameless.Absyn.FunType _funtype = (Syntax.nameless.Absyn.FunType) foo;
       if (_i_ > 0) render(_L_PAREN);
       pp(_funtype.type_1, 0);
       render("->");
  ...
  private static void sh(Syntax.nameless.Absyn.Program foo)
  {
    if (foo instanceof Syntax.nameless.Absyn.ProgramExprs)
    {
       Syntax.nameless.Absyn.ProgramExprs _programexprs = (Syntax.nameless.Absyn.ProgramExprs) foo;
  ...
  private static void sh(Syntax.nameless.Absyn.ListExpr foo)
  {
     for (java.util.Iterator<Syntax.nameless.Absyn.Expr> it = foo.iterator(); it.hasNext();)
     {
       sh(it.next());
       if (it.hasNext())
         render(",");
  ...
  private static void sh(Syntax.nameless.Absyn.Expr foo)
  {
    ...
    if (foo instanceof Syntax.nameless.Absyn.Abstraction)
    {
       ...
       render("(");
       render("Abstraction");
       sh(_abstraction.type_1);
       sh(_abstraction.ident_);
       sh(_abstraction.type_2);
  ...
  private static void sh(Syntax.nameless.Absyn.Type foo)
  {
    if (foo instanceof Syntax.nameless.Absyn.BoolType)
    {
       Syntax.nameless.Absyn.BoolType _booltype = (Syntax.nameless.Absyn.BoolType) foo;
    ...
    if (foo instanceof Syntax.nameless.Absyn.IntType)
    {
       Syntax.nameless.Absyn.IntType _inttype = (Syntax.nameless.Absyn.IntType) foo;
       render("IntType");
    }
    if (foo instanceof Syntax.nameless.Absyn.FunType)
    {
       Syntax.nameless.Absyn.FunType _funtype = (Syntax.nameless.Absyn.FunType) foo;
       render("(");
       render("FunType");
